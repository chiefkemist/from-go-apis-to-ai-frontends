...
#+begin_src go :tangle demos/demo2.go :mkdirp yes :cache no
package main
...
#+begin_src go :tangle demos/demo3.go :mkdirp yes :cache no
package main
...
rm -rf contracts/demo4.yaml # delete if already exists

cue def contracts/image.cue -o contracts/demo4.yaml --out openapi+yaml # generate schema

cat contracts/demo4.yaml # show the contents of the resulting file
...
go run cli.go y2j contracts/demo2.yaml demos/demo4/openapi.json
